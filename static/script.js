    ...
    featuredSlider: function() {
      ...
      $('.featured-post-slider').each(function() {
        ...
        $this.slick({
          ...
          initialSlide: 0,
          dots: false,
          prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="Poprzedni" tabindex="0" role="button">Poprzedni<i><svg class="" viewBox="0 0 35 10"><use xlink:href="/ui-icons.svg#arrow-left-long-icon"></use></svg></i></button>',
          nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Następny" tabindex="0" role="button">Następny<i><svg class="" viewBox="0 0 35 10"><use xlink:href="/ui-icons.svg#arrow-right-long-icon"></use></svg></i></button>',
          touchThreshold: 20,
          slidesToShow: 1,
